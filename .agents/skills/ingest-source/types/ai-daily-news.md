# AI Daily News Ingest

Use this file when the source is one issue from the Daily AI Newsletter mail workflow, typically from `rohanpaul+daily-ai-newsletter@substack.com`.

## What Counts

- one dated issue from the Daily AI Newsletter email workflow
...
Do not use this flow for arbitrary AI news webpages. Use `webpage.md` for those.
...
Treat the newsletter as a secondary source. Important claims should still be verified against primary sources before promoting them into stable wiki pages.
...
- `source/newsletter-email-2026-04-17.html`: preserved raw email artifact
- `source/newsletter-issue-2026-04-17.md`: cleaned issue snapshot with original order preserved
- `summary.md`: the collection summary and usage guide

## Sources

- [[source/newsletter-email-2026-04-17|newsletter-email-2026-04-17.html]]
- [[source/newsletter-issue-2026-04-17|newsletter-issue-2026-04-17.md]]
```
